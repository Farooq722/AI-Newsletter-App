          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-3 border border-transparent text-sm font-medium rounded-md cursor-pointer text-white bg-blue-600 hover:bg-blue-700 transition-colors"
              >
                <svg
                ...
                <>
                  {preferences.is_active ? (
                    <button
                      ...
                      className="w-full flex items-center justify-center px-4 py-3 border border-red-300 text-sm font-medium rounded-md cursor-pointer text-red-700 bg-red-50 hover:bg-red-100 transition-colors"
                    >
                      <svg
                        className="w-5 h-5 mr-2"
                        fill="none"
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center px-4 py-3 border border-green-300 text-sm font-medium rounded-md cursor-pointer text-green-700 bg-green-50 hover:bg-green-100 transition-colors"
                    >
                      <svg
                        className="w-5 h-5 mr-2"
                        fill="none"
